...
(function () {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      body: 'Each row in the Cases page has a small + Queue button. Click it to pin the case to your Action Queue; click again (now ✓ Queued) to remove it. The case stays in the Cases table either way.',
    },
    {
      kind: 'pointer',
      route: '#/cases',
