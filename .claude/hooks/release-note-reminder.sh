...
#
# Fires when Claude finishes a turn. If code under prototype/ or local/ has changed (either in
# commits not yet pushed to the upstream branch, or uncommitted in the working tree) but
